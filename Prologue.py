...
#class selection
print("next question for you then " + pcname + ", what is your class?\n1.Warrior    A Manly Man\n2.Thief    A sneaky fellow who hides in the shaddows\n3.Mage   Your'e a wizard Harry\n4.Priest There is no such thing as God\n5.Paladin    If you pick this you are clearly boring")
question2 = input()
